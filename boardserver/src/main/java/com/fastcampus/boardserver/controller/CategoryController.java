...
public class CategoryController {
	...
	public void registerCateogry(String accountId, @RequestBody CategoryDTO categoryDTO) {
	...
	public void updateCategories(String accountId
		...
		CategoryDTO categoryDTO = new CategoryDTO(categoryId, categoryRequest.getName(), CategoryDTO.SortStatus.NEWST, 10, 1);
